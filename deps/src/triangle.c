...
ANSILOCALDECL int triunsuitable(vertex triorg, vertex tridest, vertex triapex, REAL area)
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void triexit(int status)
#else /* not ANSI_DECLARATORS */
void triexit(status)
int status;
#endif /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL VOID *trimalloc(int size)
#else /* not ANSI_DECLARATORS */
VOID *trimalloc(size)
int size;
#endif /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void trifree(VOID *memptr)
#else /* not ANSI_DECLARATORS */
void trifree(memptr)
VOID *memptr;
#endif /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void parsecommandline(int argc, char **argv, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void printtriangle(struct mesh *m, struct behavior *b, struct otri *t)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void printsubseg(struct mesh *m, struct behavior *b, struct osub *s)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void poolzero(struct memorypool *pool)
#else /* not ANSI_DECLARATORS */
void poolzero(pool)
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void poolrestart(struct memorypool *pool)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void poolinit(struct memorypool *pool, int bytecount, int itemcount,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void pooldeinit(struct memorypool *pool)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL VOID *poolalloc(struct memorypool *pool)
#else /* not ANSI_DECLARATORS */
VOID *poolalloc(pool)
struct memorypool *pool;
#endif /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void pooldealloc(struct memorypool *pool, VOID *dyingitem)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void traversalinit(struct memorypool *pool)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL VOID *traverse(struct memorypool *pool)
#else /* not ANSI_DECLARATORS */
VOID *traverse(pool)
struct memorypool *pool;
#endif /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void dummyinit(struct mesh *m, struct behavior *b, int trianglebytes,
               int subsegbytes)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void initializevertexpool(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void initializetrisubpools(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void triangledealloc(struct mesh *m, triangle *dyingtriangle)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL triangle *triangletraverse(struct mesh *m)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void subsegdealloc(struct mesh *m, subseg *dyingsubseg)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL subseg *subsegtraverse(struct mesh *m)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void vertexdealloc(struct mesh *m, vertex dyingvertex)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL vertex vertextraverse(struct mesh *m)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void badsubsegdealloc(struct mesh *m, struct badsubseg *dyingseg)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL struct badsubseg *badsubsegtraverse(struct mesh *m)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL vertex getvertex(struct mesh *m, struct behavior *b, int number)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void triangledeinit(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void maketriangle(struct mesh *m, struct behavior *b, struct otri *newotri)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void makesubseg(struct mesh *m, struct osub *newsubseg)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL int fast_expansion_sum_zeroelim(int elen, REAL *e, int flen, REAL *f, REAL *h)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL int scale_expansion_zeroelim(int elen, REAL *e, REAL b, REAL *h)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL REAL estimate(int elen, REAL *e)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL REAL counterclockwiseadapt(vertex pa, vertex pb, vertex pc, REAL detsum)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL REAL counterclockwise(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL REAL incircleadapt(vertex pa, vertex pb, vertex pc, vertex pd, REAL permanent)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL REAL incircle(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL REAL orient3dadapt(vertex pa, vertex pb, vertex pc, vertex pd,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL REAL orient3d(struct mesh *m, struct behavior *b,
              vertex pa, vertex pb, vertex pc, vertex pd,
              REAL aheight, REAL bheight, REAL cheight, REAL dheight)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL REAL nonregular(struct mesh *m, struct behavior *b,
                vertex pa, vertex pb, vertex pc, vertex pd)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void findcircumcenter(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void triangleinit(struct mesh *m)
#else /* not ANSI_DECLARATORS */
void triangleinit(m)
struct mesh *m;
#endif /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL unsigned long randomnation(unsigned int choices)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void checkmesh(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
void checkmesh(m, b)
struct mesh *m;
struct behavior *b;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void checkdelaunay(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void enqueuebadtriang(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void enqueuebadtri(struct mesh *m, struct behavior *b, struct otri *enqtri,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL struct badtriang *dequeuebadtriang(struct mesh *m)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL int checkseg4encroach(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void testtriangle(struct mesh *m, struct behavior *b, struct otri *testtri)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void makevertexmap(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL enum locateresult preciselocate(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL enum locateresult locate(struct mesh *m, struct behavior *b,
                         vertex searchpoint, struct otri *searchtri)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void insertsubseg(struct mesh *m, struct behavior *b, struct otri *tri,
                  int subsegmark)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void flip(struct mesh *m, struct behavior *b, struct otri *flipedge)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void unflip(struct mesh *m, struct behavior *b, struct otri *flipedge)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL enum insertvertexresult insertvertex(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void triangulatepolygon(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void deletevertex(struct mesh *m, struct behavior *b, struct otri *deltri)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void undovertex(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
void undovertex(m, b)
struct mesh *m;
struct behavior *b;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void vertexsort(vertex *sortarray, int arraysize)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void vertexmedian(vertex *sortarray, int arraysize, int median, int axis)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void alternateaxes(vertex *sortarray, int arraysize, int axis)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void mergehulls(struct mesh *m, struct behavior *b, struct otri *farleft,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void divconqrecurse(struct mesh *m, struct behavior *b, vertex *sortarray,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL long removeghosts(struct mesh *m, struct behavior *b, struct otri *startghost)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL long divconqdelaunay(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void boundingbox(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL long removebox(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
long removebox(m, b)
struct mesh *m;
struct behavior *b;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL long incrementaldelaunay(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void eventheapinsert(struct event **heap, int heapsize, struct event *newevent)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void eventheapify(struct event **heap, int heapsize, int eventnum)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void eventheapdelete(struct event **heap, int heapsize, int eventnum)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void createeventheap(struct mesh *m, struct event ***eventheap,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL int rightofhyperbola(struct mesh *m, struct otri *fronttri, vertex newsite)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL REAL circletop(struct mesh *m, vertex pa, vertex pb, vertex pc, REAL ccwabc)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void check4deadevent(struct otri *checktri, struct event **freeevents,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL struct splaynode *splay(struct mesh *m, struct splaynode *splaytree,
                        vertex searchpoint, struct otri *searchtri)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL struct splaynode *splayinsert(struct mesh *m, struct splaynode *splayroot,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL struct splaynode *circletopinsert(struct mesh *m, struct behavior *b,
                                  struct splaynode *splayroot,
                                  struct otri *newkey,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL struct splaynode *frontlocate(struct mesh *m, struct splaynode *splayroot,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL long sweeplinedelaunay(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL long delaunay(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
long delaunay(m, b)
struct mesh *m;
struct behavior *b;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL int reconstruct(struct mesh *m, struct behavior *b, int *trianglelist,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL long reconstruct(struct mesh *m, struct behavior *b, char *elefilename,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL enum finddirectionresult finddirection(struct mesh *m, struct behavior *b,
                                       struct otri *searchtri,
                                       vertex searchpoint)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void segmentintersection(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL int scoutsegment(struct mesh *m, struct behavior *b, struct otri *searchtri,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void conformingedge(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void delaunayfixup(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void constrainededge(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void insertsegment(struct mesh *m, struct behavior *b,
                   vertex endpoint1, vertex endpoint2, int newmark)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void markhull(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
void markhull(m, b)
struct mesh *m;
struct behavior *b;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void formskeleton(struct mesh *m, struct behavior *b, int *segmentlist,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void infecthull(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
void infecthull(m, b)
struct mesh *m;
struct behavior *b;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void plague(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
void plague(m, b)
struct mesh *m;
struct behavior *b;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void regionplague(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void carveholes(struct mesh *m, struct behavior *b, REAL *holelist, int holes,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void tallyencs(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
void tallyencs(m, b)
struct mesh *m;
struct behavior *b;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void splitencsegs(struct mesh *m, struct behavior *b, int triflaws)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void tallyfaces(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
void tallyfaces(m, b)
struct mesh *m;
struct behavior *b;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void splittriangle(struct mesh *m, struct behavior *b,
                   struct badtriang *badtri)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void enforcequality(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void highorder(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
void highorder(m, b)
struct mesh *m;
struct behavior *b;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL char *readline(char *string, FILE *infile, char *infilename)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL char *findfield(char *string)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void readnodes(struct mesh *m, struct behavior *b, char *nodefilename,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void transfernodes(struct mesh *m, struct behavior *b, REAL *pointlist,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void readholes(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void finishfile(FILE *outfile, int argc, char **argv)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writenodes(struct mesh *m, struct behavior *b, REAL **pointlist,
                REAL **pointattriblist, int **pointmarkerlist)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writenodes(struct mesh *m, struct behavior *b, char *nodefilename,
                int argc, char **argv)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void numbernodes(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writeelements(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writeelements(struct mesh *m, struct behavior *b, char *elefilename,
                   int argc, char **argv)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writepoly(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writepoly(struct mesh *m, struct behavior *b, char *polyfilename,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writeedges(struct mesh *m, struct behavior *b,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writeedges(struct mesh *m, struct behavior *b, char *edgefilename,
                int argc, char **argv)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writevoronoi(struct mesh *m, struct behavior *b, REAL **vpointlist,
                  REAL **vpointattriblist, int **vpointmarkerlist,
                  int **vedgelist, int **vedgemarkerlist, REAL **vnormlist)
#else /* not ANSI_DECLARATORS */
ANSILOCALDECL void writevoronoi(m, b, vpointlist, vpointattriblist, vpointmarkerlist,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writevoronoi(struct mesh *m, struct behavior *b, char *vnodefilename,
                  char *vedgefilename, int argc, char **argv)
#else /* not ANSI_DECLARATORS */
ANSILOCALDECL void writevoronoi(m, b, vnodefilename, vedgefilename, argc, argv)
struct mesh *m;
struct behavior *b;
char *vnodefilename;
char *vedgefilename;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writeneighbors(struct mesh *m, struct behavior *b, int **neighborlist)
#else /* not ANSI_DECLARATORS */
ANSILOCALDECL void writeneighbors(m, b, neighborlist)
struct mesh *m;
struct behavior *b;
int **neighborlist;
#endif /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writeneighbors(struct mesh *m, struct behavior *b, char *neighborfilename,
                    int argc, char **argv)
#else /* not ANSI_DECLARATORS */
ANSILOCALDECL void writeneighbors(m, b, neighborfilename, argc, argv)
struct mesh *m;
struct behavior *b;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void writeoff(struct mesh *m, struct behavior *b, char *offfilename,
              int argc, char **argv)
#else /* not ANSI_DECLARATORS */
ANSILOCALDECL void writeoff(m, b, offfilename, argc, argv)
struct mesh *m;
struct behavior *b;
char *offfilename;
int argc;
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void quality_statistics(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
ANSILOCALDECL void quality_statistics(m, b)
struct mesh *m;
struct behavior *b;
#endif /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void statistics(struct mesh *m, struct behavior *b)
#else /* not ANSI_DECLARATORS */
ANSILOCALDECL void statistics(m, b)
struct mesh *m;
struct behavior *b;
#endif /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL void triangulate(char *triswitches, struct triangulateio *in,
...
#ifdef ANSI_DECLARATORS
ANSILOCALDECL int main(int argc, char **argv)
#else /* not ANSI_DECLARATORS */
int main(argc, argv)
int argc;
char **argv;
